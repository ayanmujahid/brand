...
<section class="inner-banner-row">
    <div class="container-fluid">
        <div class="inner-banner-sec">
            ...
            <p>We at Designatrix tell captivating, engaging, and conversion-boosting visual storytelling in addition to making animations. With the help of our video animation services, your concepts may be transformed into impactful motion pictures that captivate viewers and speak louder than words.</p>
        ...
        <div class="row align-items-end">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                <div class="service-choose-sec">
                    ...
                    <p>Customers are 64% more likely to buy after watching a branded video. With Designatrix, your video isn’t just seen—it sells.</p>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                <div class="service-choose-sec">
                    <img loading="lazy" src="assets/images/video-choose.jpg" alt="service choose image">
                </div>
            </div>
        </div>
    </div>
