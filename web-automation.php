...
<section class="inner-banner-row">
    <div class="container-fluid">
        <div class="inner-banner-sec">
            <h1>Web Automation Services That Simplify, <br>Streamline, and Supercharge Your Business</h1>
            <p>Automation is not only a benefit but also a need in the fast-paced digital world of today. Our site automation services at WebDesign Sigma are designed to assist companies in cutting expenses, saving time, and getting rid of tedious duties so you can concentrate on what really counts: expansion and growth.</p>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                <div class="service-about-lft">
                    <h2>Web Automation</h2>
                    <img loading="lazy" src="assets/images/web-auto-about.jpg" alt="service about image">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                <div class="service-about-sec smm-service-sec">
                    <h3>Smarter Systems, Faster Results, Better Profits</h3>
                    <p>Our automation service solutions are made to streamline intricate processes and boost output throughout your company. We incorporate intelligent tools and procedures to keep your business operating smoothly around the clock, from data handling and order processing to marketing and analytics.</p>
                    <p>In order to make sure your digital operations are as effective as your goals, we assist you in automating website tasks, including form submissions, email responses, user data updates, and more. Contact us today and get more details on how you can make your business operations run more effectively and efficiently. </p>
                    <p>As a startup or a growing brand, our automation designs will assist you in getting rid of the bottlenecks, raising the accuracy, and giving you hours per week back so you can concentrate on what matters.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row align-items-end">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                <div class="service-choose-sec">
                    <p>For businesses ready to take automation to the next level, our automation expertise helps unify your operations under one smart platform. We automate reporting, approval, and workflow processes to remove manual bottlenecks and improve departmental cooperation. We provide: </p>
                    <p>● End-to-end automation services customised to meet your company's requirements. <br>
                        ● Proficiency in automating customer support and websites. <br>
                        ● Dependable automated testing of websites to ensure optimal performance. <br>
                        ● Ongoing assistance and dedicated automation people services. <br>
                        ● Connectivity with industry-leading solutions.
                    </p>
                    <p>The result? Fewer tasks. Faster results. Happier teams. Higher ROI.</p>
                    <h3>Automate to Elevate</h3>
                    <p>Time is your most valuable asset. Designatrix helps you protect it—with automation solutions that boost performance, not complexity.</p>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                <div class="service-choose-sec">
                    <img loading="lazy" src="assets/images/web-auto-choose.jpg" alt="service choose image">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
                    <div class="packages-sec">
                        ...
                        <h2><span class="currency_symbol">$</span>2,999<span><s></s></span></h2>
                        <ul class="list">
                        ...
                        <div class="row btn-place">
                            <div class="col-md-12"> <a data-title="Business Website Package - $2999" class="w-btn activate_package  various">Place Your Order</a> </div>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
                    <div class="packages-sec">
                        <h4>AUTOMATED/INTERACTIVE CONFERENCING PORTAL<br> Package </h4>
                        <h2><span class="currency_symbol">$</span>5,000<span><s></s></span></h2>
                        <ul class="list">
                            <li class="heading">Website </li>
                        ...
                        <div class="row btn-place">
                            <div class="col-md-12"> <a data-title="Automated/Interactive Conferencing Portal Package - $5000" class="w-btn activate_package  various">Place Your Order</a> </div>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
