...
<section class="inner-banner-row">
    <div class="container-fluid">
        <div class="inner-banner-sec inner-service-banner">
            <h1>Transparent Pricing, Tangible Results </h1>
            <p>Get premium digital solutions without the premium price tag. At Designatrix, we think that prices should be transparent and appropriate for each phase of your company's development.</p>
            <h2>Packages</h2>
        </div>
    </div>
...
<section class="packages-row inner-packages-row">
    <div class="container-fluid">
        <div class="packages-head">
            <div class="pkg-flex">
                <h2>No Guesswork. Only Growth.</h2>
                <p>Flexibility and value are key considerations in the creation of our pricing schemes. We have a package for you, regardless of whether you are a brand expanding or a small firm just getting started. We only offer transparent pricing and quantifiable results; we don't utilise jargon or conceal expenses. You get closer to digital perfection with each dollar you spend. Select the strategy that best suits your objectives, and together, let's create your success narrative</p>
            </div>
            <p>Your clients visit your site not only online but also through platforms, screens, and channels. Each click, scroll, and engagement that your users experience with your web pages is seamless and strategic within our Complete Digital Experience Package. Whether that is a responsive, high-converting website, integrated SEO tools, branding and social media tools, we join the dots all together to present one digital image that brings results. This is not only design or development; this is the entire package to take over in your space and grow online, anywhere where your audience can be found.</p>
        </div>
        ...
        <div class="testimonials-slider">
            <div id="testimonials-carousel" class="owl-carousel">
                <div class="item">
                    <div class="testimonials-sec">
                        <div class="author-box">
                            <img src="assets/images/client-img1.png" alt="client image">
                            <div class="text">
                                <h3>Liam D.</h3>
                ...
                <div class="item">
                    <div class="testimonials-sec">
                        <div class="author-box">
                            <img src="assets/images/client-img2.png" alt="client image">
                            <div class="text">
                                <h3>Jason M.</h3>
                ...
                <div class="item">
                    <div class="testimonials-sec">
                        <div class="author-box">
                            <img src="assets/images/client-img3.png" alt="client image">
                            <div class="text">
                                <h3>Catherine P. </h3>
                ...
                <div class="item">
                    <div class="testimonials-sec">
                        <div class="author-box">
                            <img src="assets/images/client-img4.png" alt="client image">
                            <div class="text">
                                <h3>Thomas K</h3>
                                <h4>Consultant</h4>
                            </div>
                ...
                <div class="item">
                    <div class="testimonials-sec">
                        <div class="author-box">
                            <img src="assets/images/client-img5.png" alt="client image">
                            <div class="text">
                                <h3>Emily S</h3>
                                <h4>Startup Founder</h4>
                            </div>
