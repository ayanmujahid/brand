...
<section class="inner-banner-row">
    <div class="container-fluid">
        <div class="inner-banner-sec inner-service-banner">
            <h1>Turn Your Clicks Into Customers. Build, Sell, And <br>Scale With Confidence </h1>
            <p>Your store deserves more than a digital shelf. Our goal at Designatrix is to turn your e-commerce website into a potent sales tool that draws visitors in, keeps them interested, and encourages them to buy. </p>
            <h2>Ecomerce Solutions</h2>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                <div class="service-about-lft">
                    <h2>Ecomerce Solutions</h2>
                    <img width="400" height="300" loading="lazy" src="assets/images/ecommerce-about.jpg" alt="service about image">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                <div class="service-about-sec">
                    <h3>We Build Stores That Sell, Not Just Sites That Show</h3>
                    <p>Do you have the products, but need a platform to sell them? A product can be posted online by anybody. We help you sell it more effectively. Our skilled e-commerce website development team creates mobile-friendly, secure, and quick platforms that make buying a breeze. Every component, from functionality to graphics, is designed to improve user experience, boost conversions, and fortify trust.</p>
                    <p>We develop solutions that grow with your goals, whether you're starting a new online store or updating your current one. Designatrix is your growth partner, whether you want a completely new e-commerce website design, a revamp of your existing business, or full-scale e-commerce website development.</p>
                    <p>Contact us today, and let’s make your e-commerce website your brand’s best-performing salesperson.</p>
                    <p>Your dream store deserves more than just a pretty layout—it needs to convert, compel, and cash in. At Designatrix, we design e-commerce platforms that speak directly to your buyer’s mind. From the first scroll to the final checkout, every page is crafted with psychology-driven design, persuasive copy, and frictionless navigation that guides visitors to purchase.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="service-choose-row">
    <div class="container-fluid">
        <div class="service-choose-head">
            <h2>Smart Solutions for Every E-Commerce Business</h2>
        </div>
        <div class="row align-items-end">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                <div class="service-choose-sec">
                    <h3> Development Services for Custom Ecommerce Websites</h3>
                    <p>The personality and mission of your brand should be reflected in your online store. Our e-commerce website creation services are therefore customised rather than pre-made. We use custom frameworks and platforms like Shopify, WooCommerce, and Magento to design for scalability, speed, and security.</p>
                    <h3>
                        SEO Services for E-Commerce That Attract Customers to You
                        s</h3>
                    <p>Get the word out about your fantastic products. Where it counts most, your store will rank highly thanks to our effective e-commerce SEO services. We assist you in getting in front of clients who are prepared to make a purchase, from technical SEO and keyword optimisation to product page refining.</p>
                    <h3>Smooth Purchasing Processes.</h3>
                    <p>Conversions shouldn't be lost throughout the checkout process. We create user-friendly, safe, and secure payment systems that boost confidence and lower cart abandonment rates.</p>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                <div class="service-choose-sec">
                    <img width="400" height="300" loading="lazy" src="assets/images/ecommerce-choose.jpg" alt="service choose image">
                </div>
            </div>
        </div>
    </div>
