...
<section class="inner-banner-row">
    <div class="container-fluid">
        <div class="inner-banner-sec inner-service-banner">
            <h1>Ordinary Idea to Profitable Reality. Build Apps That <br> Connect, Convert, and Create Lasting Impact</h1>
            <p>Your app is more than simply a tool in today's mobile-first environment; it's your brand in the hands of your users. At Designatrix, we develop mobile experiences that motivate people to take action, provide value, and spur expansion. </p>
            <h2>Mobile App</h2>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                <div class="service-about-lft">
                    <h2>Mobile App</h2>
                    <img loading="lazy" src="assets/images/mobile-about.jpg" alt="service about image">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                <div class="service-about-sec">
                    <h3>We Design for People, Not Just for Phones</h3>
                    <p>Your users download experiences rather than software. For this reason, we design journeys rather than merely writing code. We create applications that are easy to use, have a beautiful appearance, and function seamlessly from the very first tap to the last checkout.</p>
                    <p>Our designers research actual user behaviour, and our developers execute that understanding with accuracy and efficiency. Apps that users love to keep and want to use are the outcome.</p>
                    <p>We create scalable mobile solutions for both local and international brands. Our clients range from established organisations hoping to improve customer experience or boost online sales to startups seeking their first MVP. Want to be one of them? Then contact us today and let us handle all your mobile application worries. </p>
                    <p>And yes, we handle everything—from planning and UI/UX to iOS and Android development, testing, and deployment. You get a full-service team that speaks your language and delivers what matters most: an app that works and performs in the real world.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="service-choose-row">
    <div class="container-fluid">
        <div class="service-choose-head">
            <h2>Maintain, Upgrade, And Evolve With Our Mobile App Service </h2>
        </div>
        <div class="row align-items-end">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                <div class="service-choose-sec">
                    <h3 style=>Development of Custom Mobile Applications</h3>
                    <p>We create custom apps from conception to release that precisely match your company's objectives. Whether it's cross-platform, iOS, or Android, our team guarantees scalability that expands with you, smooth functioning, and a clean design.</p>
                    <h3 style=>UX/UI Design That Engages</h3>
                    <p>Excellent design is the foundation of any excellent app. We design user interfaces that are clear, interesting, and designed to keep users coming back. Each motion effect, icon, and screen is purposefully designed to improve usability and brand perception.</p>
                    <h3>Automation & App Integration</h3>
                    <p>To improve efficiency and establish a linked experience, we integrate your app with current systems, such as cloud tools, eCommerce stores, payment gateways, and CRMs.</p>
                    <h3 style=>Testing, strategy, and optimisation</h3>
                    <p>We don't simply construct and disappear. We make sure your software runs smoothly, loads fast, and meets or surpasses user expectations by carefully planning, testing, and continuously improving.</p>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                <div class="service-choose-sec">
                    <img loading="lazy" src="assets/images/mobile-choose.jpg" alt="service choose image">
                </div>
            </div>
        </div>
    </div>
