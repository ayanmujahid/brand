...
<section class="inner-banner-row">
    <div class="container-fluid">
        <div class="inner-banner-sec">
            <h1>About <br>Us</h1>
            <p>We’re a creative-driven, strategy-led team offering end-to-end web design services and website development solutions for businesses of all sizes. Whether you’re a new startup or an established brand, we help you build your digital identity from the ground up</p>
            <h2>About Us</h2>
        </div>
    </div>
...
<section class="about-row about-page-row">
    <div class="container-fluid">
        <div class="row align-items-center">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                <div class="w-sec about-sec">
                    <h3>Who We Are</h3>
                    <h2>We Design. We Develop. <span>We Deliver Growth.</span></h2>
                    <p>At Designatrix, we’re more than a website design company; we’re your digital growth partners. We specialize in creating professional websites that blend beauty with performance, helping businesses stand out, attract customers, and convert clicks into revenue.</p>
                    <p>Our team of expert website designers, developers, and digital strategists knows that your website isn’t just an online presence; it’s your most powerful marketing tool. That’s why we focus on creating sites that are fast, functional, SEO-optimized, and built to sell.</p>
                    <!--<ul>-->
                    <!--    <li><strong>Building Your Online Presence</strong>-->
                    <!--    We help your brand stand out with innovative design, SEO, and social-->
                    <!--    media strategies—so you get seen, heard, and remembered online.</li>-->
                    <!--    <li><strong>Crafting Websites that Convert</strong>-->
                    <!--    We design websites that don’t just look good—they work hard. Fast,-->
                    <!--    mobile-ready, and built to turn visitors into customers.</li>-->
                    <!--</ul>-->
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
        ...
        <div class="row row-reverse align-items-center">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-5">
                <div class="about-inner-sec">
                    <img loading="lazy" src="assets/images/mission-img.jpg" alt="about image">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-7">
                <div class="w-sec about-inner-sec">
                    <h2><span>our mission</span></h2>
                    <p>To help businesses of all sizes build a meaningful online presence through smart web design services, thoughtful branding, and powerful digital strategy. We exist to turn your vision into a measurable digital success where every pixel, page, and post drives real business results.</p>
                    <p>We don’t believe in templates or one-size-fits-all design. Your brand is unique, and your website should be too. That’s why every project starts with a conversation, not a contract.</p>
                </div>
            </div>
        </div>
        <div class="row align-items-center">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-7">
                <div class="w-sec about-inner-sec">
                    ...
                    <p>To become the world’s most trusted name in web design and website design services, known for creativity, transparency, and lasting impact. We aim to empower brands to compete confidently in the digital marketplace through human-centered design, advanced development, and sustainable growth strategies.</p>
                    <p>This is why our process is built around understanding your goals, audience, and competition before writing a single line of code. The result? A professional website that’s not just beautiful, but strategic, responsive, and built to perform.</p>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-5">
                <div class="about-inner-sec">
                    <img loading="lazy" src="assets/images/vision-img.jpg" alt="about image">
                </div>
            </div>
        </div>
    </div>
